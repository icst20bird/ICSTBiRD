count=0
unsuccess=0
input="/home/ridhi/Documents/thread/pin-2.14-71313-gcc.4.4.7-linux/source/tools/ManualExamples/endrun.out"
...
do
	...
	rm $FILE
	timeout -sKILL 3s $PIN_ROOT/pin.sh -t obj-intel64/Shadow.so -- $APP >> $FILE
	    if [ $? != 0 ]; then 
